...
public class BluetoothSerial {
     ...
     * @param listener The {@link com.defqx.classic.BluetoothSerial} to use.
     */
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MESSAGE_READ:
                    ...
                    String temp = bytes2HexString(bufferRead);

//                    Log.d("Receive-MESSAGE_READ", ""+ Integer.parseInt(temp.substring(40,48), 16));
                    mListener.onBluetoothSerialRead(temp);   //转为16进制字符串，让app处理
                    if (isRaw) {
                ...
                case MESSAGE_DEVICE_INFO:
                    ...
                    Log.d("Receive-DEVICE_INFO", "deviceName:"+mConnectedDeviceName+" deviceAddr:"+mConnectedDeviceAddress);
                    break;
            }
        }
    };
